...
class TemporalTransformer(nn.Module):
    def __init__(self, feature_dim: int = 10, d_model: int = 256, num_layers: int = 2, num_heads: int = 8, dropout: float = 0.1, max_time: int = 10):
        super().__init__()
...
if __name__ == "__main__":
    ...
    model = build_model(feature_dim=F, d_model=256, num_layers=2, num_heads=8, dropout=0.1, max_time=10)
    model.eval()
