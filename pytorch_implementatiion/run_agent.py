...
class TorchAgent:
    """
    Wrapper around the PyTorch model to match the minimal interface used by the TF agent:
...
model_names = ['ak47_sub_55k_drop_d4_dmexpert_28']
...
for training_iter in range(n_iters_total):
    ...
    # Load PyTorch model (kept outside TF loader)
