...
class TemporalEncoder(nn.Module):
    def __init__(self, feature_dim: int = 13, d_model: int = 256, nhead: int = 8, num_layers: int = 2, dropout: float = 0.1, max_agents: int = 20):
        super().__init__()
...
class SpatialTransformer(nn.Module):
    def __init__(self, feature_dim: int = 10, d_model: int = 256, num_layers: int = 2, num_heads: int = 8, dropout: float = 0.1, max_agents: int = 10):
        super().__init__()
